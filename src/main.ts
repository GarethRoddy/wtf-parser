...
async function testWTF(wtfFilePath, csvPath) {
  ...
  //  console.log("Event 1:", take(eventRecords.filter(r => r.Time.8toISOString() >= '2001-06-15T15:29:00'), 10));
    ...
    console.log("Event Records (sensor manifest):", _.take(eventRecords.filter(r => r.Time >= new Date('2016-06-14T10:25:00Z')).filter(r => r.Type === 0x45),20) );
    ...
    console.log("testWTF: Records:", _.take(records.filter(r => r.Time >= new Date('2016-06-14T17:44:00Z')), 5));//9/6/2016 12:41
